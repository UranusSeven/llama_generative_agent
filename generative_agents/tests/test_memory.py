...
def new_memory_retriever():
    ...
    return TimeWeightedVectorStoreRetriever(vectorstore=vs, other_score_keys=["importance"], k=15)
...
def test():
    ...
    print(
        memory._score_memory_importance("Tommie remembers his dog, Bruno, from when he was a kid")
    )
